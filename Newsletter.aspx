<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Newsletter.aspx.cs" Theme="" Inherits="Newsletter" %>
...
<body style="background-color:#CDECFE; direction:ltr;" class="Newsletter">
    ...
    <div style="width:636px; margin:0 auto;">
        ...
        <asp:Repeater ID="RepeaterCoupons" runat="server">
            ...
            <tr style="padding:12px;min-height: 90px;" Height="90">
                ...
                <asp:HyperLink ID="HyperLink2" runat="server" Text='<%# (Eval("City.TitleEn") != null ? Eval("City.TitleEn") : "All Israel") + ": " + Eval("TitleEn") %>' NavigateUrl='<%# string.Format("http://anglodeals.co.il/CouponAddress.aspx?couponID={0}&SiteID={1}&Show=true",(int)Eval("ID"),2) %>' style="text-decoration:none;color:#6d6e71;font-family:Helvetica;font-size: 16px;font-weight: bold;"></asp:HyperLink>
                <br />
                <br />
