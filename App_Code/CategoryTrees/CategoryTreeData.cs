...
public class CategoryTreeData : IHierarchyData
{
    private readonly CategoryTree _current;
    ...
    {
        return new CategoryTreeCollection(_categories, _categories.Where(x => x.FromID == _current.ID));
    }

    public IHierarchyData GetParent()
    {
        CategoryTree parent = _categories.Where(x => x.ID == _current.FromID).SingleOrDefault();
        return (parent != null ? new CategoryTreeData(_categories, parent) : null);
    }
